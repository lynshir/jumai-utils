import type { GetPostcssConfigOptions } from 'egenie-postcss-preset';
...
import type { GetBabelConfigOptions } from 'egenie-babel-preset';
...
interface StyleConfig {
  ...
  px2rem?: GetPostcssConfigOptions['px2rem'];
}
