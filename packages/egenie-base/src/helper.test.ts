import { priceReg } from './common';
import { add, formatPrice, multiple, thousandthSeparator, subtract, toFixed, mapOptions, objToDict, getStaticResourceUrl } from './helper';
...
describe('helper', () => {
  ...
  test('mapOptions', () => {
    expect(mapOptions(undefined, 'id', 'name'))
      .toEqual([]);
    expect(mapOptions([], 'id', 'name'))
      .toEqual([]);
    expect(mapOptions([
      {
        id: '1',
  ...
  test('priceReg', () => {
    expect(priceReg.test('1'))
      .toBeTruthy();

    expect(priceReg.test('1.'))
      .toBeTruthy();
    expect(priceReg.test('1.1'))
      .toBeTruthy();
    expect(priceReg.test('1.11'))
      .toBeTruthy();
    expect(priceReg.test('1.111'))
      .toBeFalsy();
    expect(priceReg.test('1.a'))
      .toBeFalsy();
    expect(priceReg.test('a.1'))
      .toBeFalsy();
  });
