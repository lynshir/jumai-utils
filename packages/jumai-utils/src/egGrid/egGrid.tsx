...
import DataGrid from 'jumai-data-grid';
                        ...
                        <div className={styles.emptyRows}>
                          {showEmpty ? (
                            <>
                              <Empty
                                ...
                                image={getStaticResourceUrl('pc/ts/jumai-common/images/noMsg.png')}
                              />
                              <Button
                                onClick={onQuery}
                                type="primary"
...

                          {
                            showNormalEmpty && (
                              <Empty
                                description="暂无数据哦"
                                image={getStaticResourceUrl('pc/ts/jumai-common/images/empty.png')}
                              />
                            )
                          }
                        </div>
