...
import styles from './columnSetting.module.less';

export class ColumnSettingModel<RowT> {
  @observable public parent: EgGridModel<RowT>;
...
@observer
export class ColumnSettingModal<RowT> extends React.Component<{ store: ColumnSettingModel<RowT> ; }> {
  render() {
